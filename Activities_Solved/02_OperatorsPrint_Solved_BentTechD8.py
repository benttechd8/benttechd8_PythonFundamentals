...
'''create two variables, test your print knowledge by leveraging % call formatting method
, then calling on the vars directly, then move to f-string method!'''

var1 = "test"
var2 = 49
#using %
print("This is an int: %d and this is a string %s" % (var2, var1))

#calling directly:
print("This is an int:",var2,"and this is a string",var1)

#f-string
print(f"This an an int {var2} and this is a string {var1}")
